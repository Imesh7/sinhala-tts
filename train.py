...
def train():
    ...
    dataloader = DataModule(file_path, tokenizer).dataloader(batch_size=32)  # Create a dataloader for the training data
    ...
    for epoch in tqdm(range(start_epoch, num_epochs)):
        ...
        for batch_idx, batch_data in enumerate(dataloader):
            ...
            outputs = model(text_tokens, features,feature_lens, noise, t)  # Forward pass with noise
